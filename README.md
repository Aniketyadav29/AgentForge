...
Completed research reports can be downloaded from the report panel as `README.md` or as a formatted PDF. PDF export is generated by the application and preserves report headings, lists, tables, links, and page numbering.
